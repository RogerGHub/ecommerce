...
class Product extends Model{
	...
	public function checkPhoto(){
		...
		if (file_exists(
			...
			$url = "/res/site/img/products/SemFoto.jpg";
	...
	public function getCategories()
	{
		...
		return $sql->select("SELECT * FROM tb_categories a JOIN tb_productscategories b ON a.idcategory = b.idcategory WHERE b.idproduct = :idproduct"
			, [
				':idproduct'=>$this->getidproduct()
			]);
	}
